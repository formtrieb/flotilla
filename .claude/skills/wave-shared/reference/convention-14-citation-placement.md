...
- **Seeding measurement, same date.** 153 citation occurrences across the 12 shipped SKILL.md bodies, of which 137 already sat in a provenance position and 16 did not — spread over six files. The convention codifies what the corpus was already doing nine times out of ten; the allowlist covers the remainder.
