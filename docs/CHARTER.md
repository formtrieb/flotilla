...
- **Written:** [`0027`](adr/0027-disclosures-are-spine-captured-at-routing-and-dispositioned-before-archive.md) — **Disclosures** (Convention 9/10 gaps, Reviewer and Coordinator finds) are captured in the spine at verdict-routing through paired verbs and must reach a **Disposition** (`resolved-in-slice · scope-extension · filed:<id> · dropped:<reason>`) before `wave-close` archives — existence enforced mechanically, quality left human; amended 2026-07-31 with the triviality default and thematic bundles.
